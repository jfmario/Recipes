...
- Ingredients should be listed in a single flat list in a logical order, with no subsections or groupings. Water and other universally assumed pantry staples do not need to be listed. 
— they will be introduced inline during the steps when needed.
...
- Do not include external hyperlinks. I am maintaining credits separately.
